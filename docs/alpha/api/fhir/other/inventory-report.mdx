...
<ApiBase surface="fhir" path="/InventoryReport" inline={false} />
...
| `status` | `code` | `1..1` | draft | requested | active | entered-in-error _modifier_ |
| `countType` | `code` | `1..1` | snapshot | difference _modifier_ |
...
- Official FHIR R5 spec: [`InventoryReport`](https://hl7.org/fhir/R5/inventoryreport.html)
