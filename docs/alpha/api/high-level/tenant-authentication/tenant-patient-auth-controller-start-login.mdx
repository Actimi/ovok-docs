...
<div className="endpoint-hero__paths">
  <div className="endpoint-hero__path-row"><span className="api-method post">POST</span> <code className="endpoint-hero__path">{"/auth/tenant/Patient/login/start"}</code></div>
</div>
...
{
  "nextStep": "token",
  "sessionCode": "wsQ8DAqRYOH0antRadyaCnUkj774N7FZ"
}
```
