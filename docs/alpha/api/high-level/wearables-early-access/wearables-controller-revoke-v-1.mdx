...
<div className="endpoint-hero__paths">
  <div className="endpoint-hero__path-row"><span className="api-method delete">DELETE</span> <code className="endpoint-hero__path">{"/v1/wearables/{provider}/connections/{patientId}"}</code></div>
</div>
