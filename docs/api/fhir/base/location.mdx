...
description: Physical place where services are provided. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Physical place where services are provided.

## Endpoints

The standard FHIR R5 interactions for `Location` are mounted under your
...
| Vread        | `GET`    | `/Location/[id]/_history/[vid]` |
| Update       | `PUT`    | `/Location/[id]` |
| Patch        | `PATCH`  | `/Location/[id]` |
| Delete       | `DELETE` | `/Location/[id]` |
| Create       | `POST`   | `/Location` |
| Search       | `GET`    | `/Location?...` |
| History      | `GET`    | `/Location/[id]/_history` |
| Type-history | `GET`    | `/Location/_history` |
...
- Search parameters: [`Location` search params](https://hl7.org/fhir/R5/location.html#search)
