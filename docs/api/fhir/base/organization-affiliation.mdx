...
`OrganizationAffiliation` supports the parameters below.
...
- Element bindings & profiles: [`OrganizationAffiliation` profile](https://hl7.org/fhir/R5/organizationaffiliation-definitions.html)
