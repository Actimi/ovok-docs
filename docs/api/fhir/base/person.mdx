...
description: A generic person — linked across roles. FHIR R5 resource, served by the Ovok FHIR API.
---
...
A generic person — linked across roles.

## Endpoints

The standard FHIR R5 interactions for `Person` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/Person/[id]` |
| Vread        | `GET`    | `/Person/[id]/_history/[vid]` |
| Update       | `PUT`    | `/Person/[id]` |
| Patch        | `PATCH`  | `/Person/[id]` |
| Delete       | `DELETE` | `/Person/[id]` |
| Create       | `POST`   | `/Person` |
| Search       | `GET`    | `/Person?...` |
| History      | `GET`    | `/Person/[id]/_history` |
| Type-history | `GET`    | `/Person/_history` |
...
- Search parameters: [`Person` search params](https://hl7.org/fhir/R5/person.html#search)
