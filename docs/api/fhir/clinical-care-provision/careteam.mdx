...
description: Set of practitioners participating in care for a patient. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Set of practitioners participating in care for a patient.

## Endpoints

The standard FHIR R5 interactions for `CareTeam` are mounted under your
...
| Vread      | `GET`    | `/CareTeam/[id]/_history/[vid]` |
| Update     | `PUT`    | `/CareTeam/[id]` |
| Patch      | `PATCH`  | `/CareTeam/[id]` |
| Delete     | `DELETE` | `/CareTeam/[id]` |
| Create     | `POST`   | `/CareTeam` |
| Search     | `GET`    | `/CareTeam?...` |
| History    | `GET`    | `/CareTeam/[id]/_history` |
| Type-history | `GET`  | `/CareTeam/_history` |
...
- Search parameters: [`CareTeam` search params](https://hl7.org/fhir/R5/careteam.html#search)
