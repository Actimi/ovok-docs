...
description: A record of a communication between participants. FHIR R5 resource, served by the Ovok FHIR API.
---
...
A record of a communication between participants.

## Endpoints

The standard FHIR R5 interactions for `Communication` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/Communication/[id]` |
| Vread      | `GET`    | `/Communication/[id]/_history/[vid]` |
| Update     | `PUT`    | `/Communication/[id]` |
| Patch      | `PATCH`  | `/Communication/[id]` |
| Delete     | `DELETE` | `/Communication/[id]` |
| Create     | `POST`   | `/Communication` |
| Search     | `GET`    | `/Communication?...` |
| History    | `GET`    | `/Communication/[id]/_history` |
| Type-history | `GET`  | `/Communication/_history` |
...
- Search parameters: [`Communication` search params](https://hl7.org/fhir/R5/communication.html#search)
