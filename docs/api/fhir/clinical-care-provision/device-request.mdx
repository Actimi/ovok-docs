...
description: Request to supply or use a Device. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Request to supply or use a Device.

## Endpoints

The standard FHIR R5 interactions for `DeviceRequest` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/DeviceRequest/[id]` |
| Vread        | `GET`    | `/DeviceRequest/[id]/_history/[vid]` |
| Update       | `PUT`    | `/DeviceRequest/[id]` |
| Patch        | `PATCH`  | `/DeviceRequest/[id]` |
| Delete       | `DELETE` | `/DeviceRequest/[id]` |
| Create       | `POST`   | `/DeviceRequest` |
| Search       | `GET`    | `/DeviceRequest?...` |
| History      | `GET`    | `/DeviceRequest/[id]/_history` |
| Type-history | `GET`    | `/DeviceRequest/_history` |
...
- Search parameters: [`DeviceRequest` search params](https://hl7.org/fhir/R5/devicerequest.html#search)
