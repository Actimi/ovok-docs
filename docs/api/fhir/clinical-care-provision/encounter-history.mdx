...
`EncounterHistory` supports the parameters below.
...
- Element bindings & profiles: [`EncounterHistory` profile](https://hl7.org/fhir/R5/encounterhistory-definitions.html)
