...
description: Request for a procedure, diagnostic, or other service. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Request for a procedure, diagnostic, or other service.

## Endpoints

The standard FHIR R5 interactions for `ServiceRequest` are mounted under your
...
| Vread      | `GET`    | `/ServiceRequest/[id]/_history/[vid]` |
| Update     | `PUT`    | `/ServiceRequest/[id]` |
| Patch      | `PATCH`  | `/ServiceRequest/[id]` |
| Delete     | `DELETE` | `/ServiceRequest/[id]` |
| Create     | `POST`   | `/ServiceRequest` |
| Search     | `GET`    | `/ServiceRequest?...` |
| History    | `GET`    | `/ServiceRequest/[id]/_history` |
| Type-history | `GET`  | `/ServiceRequest/_history` |
...
- Search parameters: [`ServiceRequest` search params](https://hl7.org/fhir/R5/servicerequest.html#search)
