...
description: Request for a supply of items. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Request for a supply of items.

## Endpoints

The standard FHIR R5 interactions for `SupplyRequest` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/SupplyRequest/[id]` |
| Vread      | `GET`    | `/SupplyRequest/[id]/_history/[vid]` |
| Update     | `PUT`    | `/SupplyRequest/[id]` |
| Patch      | `PATCH`  | `/SupplyRequest/[id]` |
| Delete     | `DELETE` | `/SupplyRequest/[id]` |
| Create     | `POST`   | `/SupplyRequest` |
| Search     | `GET`    | `/SupplyRequest?...` |
| History    | `GET`    | `/SupplyRequest/[id]/_history` |
| Type-history | `GET`  | `/SupplyRequest/_history` |
...
- Search parameters: [`SupplyRequest` search params](https://hl7.org/fhir/R5/supplyrequest.html#search)
