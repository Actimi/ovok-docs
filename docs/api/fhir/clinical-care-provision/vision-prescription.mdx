...
`VisionPrescription` supports the parameters below.
...
- Element bindings & profiles: [`VisionPrescription` profile](https://hl7.org/fhir/R5/visionprescription-definitions.html)
