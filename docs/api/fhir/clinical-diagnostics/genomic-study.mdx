...
description: Genomic analysis study. FHIR R5 resource, served by the Ovok FHIR API.
---
...
The standard FHIR R5 interactions for `GenomicStudy` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/GenomicStudy/[id]` |
| Vread        | `GET`    | `/GenomicStudy/[id]/_history/[vid]` |
| Update       | `PUT`    | `/GenomicStudy/[id]` |
| Patch        | `PATCH`  | `/GenomicStudy/[id]` |
| Delete       | `DELETE` | `/GenomicStudy/[id]` |
| Create       | `POST`   | `/GenomicStudy` |
| Search       | `GET`    | `/GenomicStudy?...` |
| History      | `GET`    | `/GenomicStudy/[id]/_history` |
| Type-history | `GET`    | `/GenomicStudy/_history` |
...
- Search parameters: [`GenomicStudy` search params](https://hl7.org/fhir/R5/genomicstudy.html#search)
