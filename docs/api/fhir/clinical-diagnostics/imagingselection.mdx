...
description: Selection of images from a study. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Selection of images from a study.

## Endpoints

The standard FHIR R5 interactions for `ImagingSelection` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/ImagingSelection/[id]` |
| Vread      | `GET`    | `/ImagingSelection/[id]/_history/[vid]` |
| Update     | `PUT`    | `/ImagingSelection/[id]` |
| Patch      | `PATCH`  | `/ImagingSelection/[id]` |
| Delete     | `DELETE` | `/ImagingSelection/[id]` |
| Create     | `POST`   | `/ImagingSelection` |
| Search     | `GET`    | `/ImagingSelection?...` |
| History    | `GET`    | `/ImagingSelection/[id]/_history` |
| Type-history | `GET`  | `/ImagingSelection/_history` |
...
- Search parameters: [`ImagingSelection` search params](https://hl7.org/fhir/R5/imagingselection.html#search)
