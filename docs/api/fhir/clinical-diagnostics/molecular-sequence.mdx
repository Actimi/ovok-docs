...
`MolecularSequence` supports the parameters below.
...
- Element bindings & profiles: [`MolecularSequence` profile](https://hl7.org/fhir/R5/molecularsequence-definitions.html)
