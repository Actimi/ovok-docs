...
description: Available item in a medication formulary. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Available item in a medication formulary.

## Endpoints

The standard FHIR R5 interactions for `FormularyItem` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/FormularyItem/[id]` |
| Vread        | `GET`    | `/FormularyItem/[id]/_history/[vid]` |
| Update       | `PUT`    | `/FormularyItem/[id]` |
| Patch        | `PATCH`  | `/FormularyItem/[id]` |
| Delete       | `DELETE` | `/FormularyItem/[id]` |
| Create       | `POST`   | `/FormularyItem` |
| Search       | `GET`    | `/FormularyItem?...` |
| History      | `GET`    | `/FormularyItem/[id]/_history` |
| Type-history | `GET`    | `/FormularyItem/_history` |
...
- Search parameters: [`FormularyItem` search params](https://hl7.org/fhir/R5/formularyitem.html#search)
