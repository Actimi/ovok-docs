...
description: Record of an immunization administered. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Record of an immunization administered.

## Endpoints

The standard FHIR R5 interactions for `Immunization` are mounted under your
...
| Vread      | `GET`    | `/Immunization/[id]/_history/[vid]` |
| Update     | `PUT`    | `/Immunization/[id]` |
| Patch      | `PATCH`  | `/Immunization/[id]` |
| Delete     | `DELETE` | `/Immunization/[id]` |
| Create     | `POST`   | `/Immunization` |
| Search     | `GET`    | `/Immunization?...` |
| History    | `GET`    | `/Immunization/[id]/_history` |
| Type-history | `GET`  | `/Immunization/_history` |
...
- Search parameters: [`Immunization` search params](https://hl7.org/fhir/R5/immunization.html#search)
