...
`MedicationDispense` supports the parameters below.
...
- Element bindings & profiles: [`MedicationDispense` profile](https://hl7.org/fhir/R5/medicationdispense-definitions.html)
