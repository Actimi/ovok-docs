...
description: Risk of adverse reaction to a substance. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Risk of adverse reaction to a substance.

## Endpoints

The standard FHIR R5 interactions for `AllergyIntolerance` are mounted under your
...
| Vread        | `GET`    | `/AllergyIntolerance/[id]/_history/[vid]` |
| Update       | `PUT`    | `/AllergyIntolerance/[id]` |
| Patch        | `PATCH`  | `/AllergyIntolerance/[id]` |
| Delete       | `DELETE` | `/AllergyIntolerance/[id]` |
| Create       | `POST`   | `/AllergyIntolerance` |
| Search       | `GET`    | `/AllergyIntolerance?...` |
| History      | `GET`    | `/AllergyIntolerance/[id]/_history` |
| Type-history | `GET`    | `/AllergyIntolerance/_history` |
...
- Search parameters: [`AllergyIntolerance` search params](https://hl7.org/fhir/R5/allergyintolerance.html#search)
