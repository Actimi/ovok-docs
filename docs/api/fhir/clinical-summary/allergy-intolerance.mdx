...
`AllergyIntolerance` supports the parameters below.
...
- Element bindings & profiles: [`AllergyIntolerance` profile](https://hl7.org/fhir/R5/allergyintolerance-definitions.html)
