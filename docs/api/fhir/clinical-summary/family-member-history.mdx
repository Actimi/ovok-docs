...
`FamilyMemberHistory` supports the parameters below.
...
- Element bindings & profiles: [`FamilyMemberHistory` profile](https://hl7.org/fhir/R5/familymemberhistory-definitions.html)
