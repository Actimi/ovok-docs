...
description: Describes an actor in a workflow or scenario. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Describes an actor in a workflow or scenario.

## Endpoints

The standard FHIR R5 interactions for `ActorDefinition` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/ActorDefinition/[id]` |
| Vread      | `GET`    | `/ActorDefinition/[id]/_history/[vid]` |
| Update     | `PUT`    | `/ActorDefinition/[id]` |
| Patch      | `PATCH`  | `/ActorDefinition/[id]` |
| Delete     | `DELETE` | `/ActorDefinition/[id]` |
| Create     | `POST`   | `/ActorDefinition` |
| Search     | `GET`    | `/ActorDefinition?...` |
| History    | `GET`    | `/ActorDefinition/[id]/_history` |
| Type-history | `GET`  | `/ActorDefinition/_history` |
...
- Search parameters: [`ActorDefinition` search params](https://hl7.org/fhir/R5/actordefinition.html#search)
