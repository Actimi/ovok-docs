...
description: Definition of a condition for a clinical pathway. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Definition of a condition for a clinical pathway.

## Endpoints

The standard FHIR R5 interactions for `ConditionDefinition` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/ConditionDefinition/[id]` |
| Vread      | `GET`    | `/ConditionDefinition/[id]/_history/[vid]` |
| Update     | `PUT`    | `/ConditionDefinition/[id]` |
| Patch      | `PATCH`  | `/ConditionDefinition/[id]` |
| Delete     | `DELETE` | `/ConditionDefinition/[id]` |
| Create     | `POST`   | `/ConditionDefinition` |
| Search     | `GET`    | `/ConditionDefinition?...` |
| History    | `GET`    | `/ConditionDefinition/[id]/_history` |
| Type-history | `GET`  | `/ConditionDefinition/_history` |
...
- Search parameters: [`ConditionDefinition` search params](https://hl7.org/fhir/R5/conditiondefinition.html#search)
