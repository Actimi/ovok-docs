...
description: Definition of a graph of resources. FHIR R5 resource, served by the Ovok FHIR API.
---
...
The standard FHIR R5 interactions for `GraphDefinition` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/GraphDefinition/[id]` |
| Vread        | `GET`    | `/GraphDefinition/[id]/_history/[vid]` |
| Update       | `PUT`    | `/GraphDefinition/[id]` |
| Patch        | `PATCH`  | `/GraphDefinition/[id]` |
| Delete       | `DELETE` | `/GraphDefinition/[id]` |
| Create       | `POST`   | `/GraphDefinition` |
| Search       | `GET`    | `/GraphDefinition?...` |
| History      | `GET`    | `/GraphDefinition/[id]/_history` |
| Type-history | `GET`    | `/GraphDefinition/_history` |
...
- Search parameters: [`GraphDefinition` search params](https://hl7.org/fhir/R5/graphdefinition.html#search)
