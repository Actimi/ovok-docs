...
description: Set of requirements for a system to satisfy. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Set of requirements for a system to satisfy.

## Endpoints

The standard FHIR R5 interactions for `Requirements` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/Requirements/[id]` |
| Vread        | `GET`    | `/Requirements/[id]/_history/[vid]` |
| Update       | `PUT`    | `/Requirements/[id]` |
| Patch        | `PATCH`  | `/Requirements/[id]` |
| Delete       | `DELETE` | `/Requirements/[id]` |
| Create       | `POST`   | `/Requirements` |
| Search       | `GET`    | `/Requirements?...` |
| History      | `GET`    | `/Requirements/[id]/_history` |
| Type-history | `GET`    | `/Requirements/_history` |
...
- Search parameters: [`Requirements` search params](https://hl7.org/fhir/R5/requirements.html#search)
