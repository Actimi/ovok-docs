...
description: Definition of a search parameter for a resource. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Definition of a search parameter for a resource.

## Endpoints

The standard FHIR R5 interactions for `SearchParameter` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/SearchParameter/[id]` |
| Vread      | `GET`    | `/SearchParameter/[id]/_history/[vid]` |
| Update     | `PUT`    | `/SearchParameter/[id]` |
| Patch      | `PATCH`  | `/SearchParameter/[id]` |
| Delete     | `DELETE` | `/SearchParameter/[id]` |
| Create     | `POST`   | `/SearchParameter` |
| Search     | `GET`    | `/SearchParameter?...` |
| History    | `GET`    | `/SearchParameter/[id]/_history` |
| Type-history | `GET`  | `/SearchParameter/_history` |
...
- Search parameters: [`SearchParameter` search params](https://hl7.org/fhir/R5/searchparameter.html#search)
