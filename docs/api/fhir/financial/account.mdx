...
description: Tracks balance, charges, for a patient or encounter. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Tracks balance, charges, for a patient or encounter.

## Endpoints

The standard FHIR R5 interactions for `Account` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/Account/[id]` |
| Vread        | `GET`    | `/Account/[id]/_history/[vid]` |
| Update       | `PUT`    | `/Account/[id]` |
| Patch        | `PATCH`  | `/Account/[id]` |
| Delete       | `DELETE` | `/Account/[id]` |
| Create       | `POST`   | `/Account` |
| Search       | `GET`    | `/Account?...` |
| History      | `GET`    | `/Account/[id]/_history` |
| Type-history | `GET`    | `/Account/_history` |
...
- Search parameters: [`Account` search params](https://hl7.org/fhir/R5/account.html#search)
