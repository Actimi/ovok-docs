...
`EnrollmentResponse` supports the parameters below.
...
- Element bindings & profiles: [`EnrollmentResponse` profile](https://hl7.org/fhir/R5/enrollmentresponse-definitions.html)
