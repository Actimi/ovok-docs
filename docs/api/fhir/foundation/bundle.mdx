...
description: Container for collections of resources. FHIR R5 resource, served by the Ovok FHIR API.
---
...
The standard FHIR R5 interactions for `Bundle` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/Bundle/[id]` |
| Vread      | `GET`    | `/Bundle/[id]/_history/[vid]` |
| Update     | `PUT`    | `/Bundle/[id]` |
| Patch      | `PATCH`  | `/Bundle/[id]` |
| Delete     | `DELETE` | `/Bundle/[id]` |
| Create     | `POST`   | `/Bundle` |
| Search     | `GET`    | `/Bundle?...` |
| History    | `GET`    | `/Bundle/[id]/_history` |
| Type-history | `GET`  | `/Bundle/_history` |
...
- Search parameters: [`Bundle` search params](https://hl7.org/fhir/R5/bundle.html#search)
