...
description: Patient's directive permitting / restricting use of data. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Patient's directive permitting / restricting use of data.

## Endpoints

The standard FHIR R5 interactions for `Consent` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/Consent/[id]` |
| Vread        | `GET`    | `/Consent/[id]/_history/[vid]` |
| Update       | `PUT`    | `/Consent/[id]` |
| Patch        | `PATCH`  | `/Consent/[id]` |
| Delete       | `DELETE` | `/Consent/[id]` |
| Create       | `POST`   | `/Consent` |
| Search       | `GET`    | `/Consent?...` |
| History      | `GET`    | `/Consent/[id]/_history` |
| Type-history | `GET`    | `/Consent/_history` |
...
- Search parameters: [`Consent` search params](https://hl7.org/fhir/R5/consent.html#search)
