...
`DocumentReference` supports the parameters below.
...
- Element bindings & profiles: [`DocumentReference` profile](https://hl7.org/fhir/R5/documentreference-definitions.html)
