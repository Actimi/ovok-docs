...
description: Audit trail of who, when, why for resource changes. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Audit trail of who, when, why for resource changes.

## Endpoints

The standard FHIR R5 interactions for `Provenance` are mounted under your
...
| Vread      | `GET`    | `/Provenance/[id]/_history/[vid]` |
| Update     | `PUT`    | `/Provenance/[id]` |
| Patch      | `PATCH`  | `/Provenance/[id]` |
| Delete     | `DELETE` | `/Provenance/[id]` |
| Create     | `POST`   | `/Provenance` |
| Search     | `GET`    | `/Provenance?...` |
| History    | `GET`    | `/Provenance/[id]/_history` |
| Type-history | `GET`  | `/Provenance/_history` |
...
- Search parameters: [`Provenance` search params](https://hl7.org/fhir/R5/provenance.html#search)
