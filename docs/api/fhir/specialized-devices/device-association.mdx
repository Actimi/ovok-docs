...
| `status` | `CodeableConcept` | `1..1` | implanted | explanted | attached | entered-in-error | unknown |
...
`DeviceAssociation` supports the parameters below.
...
- Element bindings & profiles: [`DeviceAssociation` profile](https://hl7.org/fhir/R5/deviceassociation-definitions.html)
