...
<ApiBase surface="fhir" path="/DeviceDefinition" inline={false} />
...
`DeviceDefinition` supports the parameters below.
...
- Element bindings & profiles: [`DeviceDefinition` profile](https://hl7.org/fhir/R5/devicedefinition-definitions.html)
