...
description: Dispensing of a Device to a patient. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Dispensing of a Device to a patient.

## Endpoints

The standard FHIR R5 interactions for `DeviceDispense` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/DeviceDispense/[id]` |
| Vread        | `GET`    | `/DeviceDispense/[id]/_history/[vid]` |
| Update       | `PUT`    | `/DeviceDispense/[id]` |
| Patch        | `PATCH`  | `/DeviceDispense/[id]` |
| Delete       | `DELETE` | `/DeviceDispense/[id]` |
| Create       | `POST`   | `/DeviceDispense` |
| Search       | `GET`    | `/DeviceDispense?...` |
| History      | `GET`    | `/DeviceDispense/[id]/_history` |
| Type-history | `GET`    | `/DeviceDispense/_history` |
...
- Search parameters: [`DeviceDispense` search params](https://hl7.org/fhir/R5/devicedispense.html#search)
