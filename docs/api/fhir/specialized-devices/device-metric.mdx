...
description: Measurement, calculation or setting of a Device. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Measurement, calculation or setting of a Device.

## Endpoints

The standard FHIR R5 interactions for `DeviceMetric` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/DeviceMetric/[id]` |
| Vread        | `GET`    | `/DeviceMetric/[id]/_history/[vid]` |
| Update       | `PUT`    | `/DeviceMetric/[id]` |
| Patch        | `PATCH`  | `/DeviceMetric/[id]` |
| Delete       | `DELETE` | `/DeviceMetric/[id]` |
| Create       | `POST`   | `/DeviceMetric` |
| Search       | `GET`    | `/DeviceMetric?...` |
| History      | `GET`    | `/DeviceMetric/[id]/_history` |
| Type-history | `GET`    | `/DeviceMetric/_history` |
...
- Search parameters: [`DeviceMetric` search params](https://hl7.org/fhir/R5/devicemetric.html#search)
