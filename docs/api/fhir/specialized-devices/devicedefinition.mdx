...
description: Catalogue / model entry for a Device. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Catalogue / model entry for a Device.

## Endpoints

The standard FHIR R5 interactions for `DeviceDefinition` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/DeviceDefinition/[id]` |
| Vread      | `GET`    | `/DeviceDefinition/[id]/_history/[vid]` |
| Update     | `PUT`    | `/DeviceDefinition/[id]` |
| Patch      | `PATCH`  | `/DeviceDefinition/[id]` |
| Delete     | `DELETE` | `/DeviceDefinition/[id]` |
| Create     | `POST`   | `/DeviceDefinition` |
| Search     | `GET`    | `/DeviceDefinition?...` |
| History    | `GET`    | `/DeviceDefinition/[id]/_history` |
| Type-history | `GET`  | `/DeviceDefinition/_history` |
...
- Search parameters: [`DeviceDefinition` search params](https://hl7.org/fhir/R5/devicedefinition.html#search)
