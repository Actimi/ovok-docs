...
`AdministrableProductDefinition` supports the parameters below.
...
- Element bindings & profiles: [`AdministrableProductDefinition` profile](https://hl7.org/fhir/R5/administrableproductdefinition-definitions.html)
