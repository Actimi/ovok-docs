...
description: The administrable form of a medicinal product. FHIR R5 resource, served by the Ovok FHIR API.
---
...
The administrable form of a medicinal product.

## Endpoints

The standard FHIR R5 interactions for `AdministrableProductDefinition` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/AdministrableProductDefinition/[id]` |
| Vread        | `GET`    | `/AdministrableProductDefinition/[id]/_history/[vid]` |
| Update       | `PUT`    | `/AdministrableProductDefinition/[id]` |
| Patch        | `PATCH`  | `/AdministrableProductDefinition/[id]` |
| Delete       | `DELETE` | `/AdministrableProductDefinition/[id]` |
| Create       | `POST`   | `/AdministrableProductDefinition` |
| Search       | `GET`    | `/AdministrableProductDefinition?...` |
| History      | `GET`    | `/AdministrableProductDefinition/[id]/_history` |
| Type-history | `GET`    | `/AdministrableProductDefinition/_history` |
...
- Search parameters: [`AdministrableProductDefinition` search params](https://hl7.org/fhir/R5/administrableproductdefinition.html#search)
