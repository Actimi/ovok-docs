...
description: Detailed definition of a substance. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Detailed definition of a substance.

## Endpoints

The standard FHIR R5 interactions for `SubstanceDefinition` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/SubstanceDefinition/[id]` |
| Vread        | `GET`    | `/SubstanceDefinition/[id]/_history/[vid]` |
| Update       | `PUT`    | `/SubstanceDefinition/[id]` |
| Patch        | `PATCH`  | `/SubstanceDefinition/[id]` |
| Delete       | `DELETE` | `/SubstanceDefinition/[id]` |
| Create       | `POST`   | `/SubstanceDefinition` |
| Search       | `GET`    | `/SubstanceDefinition?...` |
| History      | `GET`    | `/SubstanceDefinition/[id]/_history` |
| Type-history | `GET`    | `/SubstanceDefinition/_history` |
...
- Search parameters: [`SubstanceDefinition` search params](https://hl7.org/fhir/R5/substancedefinition.html#search)
