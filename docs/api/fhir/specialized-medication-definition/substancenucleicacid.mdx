...
description: Nucleic acid substance definition. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Nucleic acid substance definition.

## Endpoints

The standard FHIR R5 interactions for `SubstanceNucleicAcid` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/SubstanceNucleicAcid/[id]` |
| Vread      | `GET`    | `/SubstanceNucleicAcid/[id]/_history/[vid]` |
| Update     | `PUT`    | `/SubstanceNucleicAcid/[id]` |
| Patch      | `PATCH`  | `/SubstanceNucleicAcid/[id]` |
| Delete     | `DELETE` | `/SubstanceNucleicAcid/[id]` |
| Create     | `POST`   | `/SubstanceNucleicAcid` |
| Search     | `GET`    | `/SubstanceNucleicAcid?...` |
| History    | `GET`    | `/SubstanceNucleicAcid/[id]/_history` |
| Type-history | `GET`  | `/SubstanceNucleicAcid/_history` |
...
- Search parameters: [`SubstanceNucleicAcid` search params](https://hl7.org/fhir/R5/substancenucleicacid.html#search)
