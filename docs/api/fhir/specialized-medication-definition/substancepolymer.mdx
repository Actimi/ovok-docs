...
description: Polymer substance definition. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Polymer substance definition.

## Endpoints

The standard FHIR R5 interactions for `SubstancePolymer` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/SubstancePolymer/[id]` |
| Vread      | `GET`    | `/SubstancePolymer/[id]/_history/[vid]` |
| Update     | `PUT`    | `/SubstancePolymer/[id]` |
| Patch      | `PATCH`  | `/SubstancePolymer/[id]` |
| Delete     | `DELETE` | `/SubstancePolymer/[id]` |
| Create     | `POST`   | `/SubstancePolymer` |
| Search     | `GET`    | `/SubstancePolymer?...` |
| History    | `GET`    | `/SubstancePolymer/[id]/_history` |
| Type-history | `GET`  | `/SubstancePolymer/_history` |
...
- Search parameters: [`SubstancePolymer` search params](https://hl7.org/fhir/R5/substancepolymer.html#search)
