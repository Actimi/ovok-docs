...
description: Protein substance definition. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Protein substance definition.

## Endpoints

The standard FHIR R5 interactions for `SubstanceProtein` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/SubstanceProtein/[id]` |
| Vread      | `GET`    | `/SubstanceProtein/[id]/_history/[vid]` |
| Update     | `PUT`    | `/SubstanceProtein/[id]` |
| Patch      | `PATCH`  | `/SubstanceProtein/[id]` |
| Delete     | `DELETE` | `/SubstanceProtein/[id]` |
| Create     | `POST`   | `/SubstanceProtein` |
| Search     | `GET`    | `/SubstanceProtein?...` |
| History    | `GET`    | `/SubstanceProtein/[id]/_history` |
| Type-history | `GET`  | `/SubstanceProtein/_history` |
...
- Search parameters: [`SubstanceProtein` search params](https://hl7.org/fhir/R5/substanceprotein.html#search)
