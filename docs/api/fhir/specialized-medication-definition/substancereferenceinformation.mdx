...
description: Reference information about a substance. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Reference information about a substance.

## Endpoints

The standard FHIR R5 interactions for `SubstanceReferenceInformation` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/SubstanceReferenceInformation/[id]` |
| Vread      | `GET`    | `/SubstanceReferenceInformation/[id]/_history/[vid]` |
| Update     | `PUT`    | `/SubstanceReferenceInformation/[id]` |
| Patch      | `PATCH`  | `/SubstanceReferenceInformation/[id]` |
| Delete     | `DELETE` | `/SubstanceReferenceInformation/[id]` |
| Create     | `POST`   | `/SubstanceReferenceInformation` |
| Search     | `GET`    | `/SubstanceReferenceInformation?...` |
| History    | `GET`    | `/SubstanceReferenceInformation/[id]/_history` |
| Type-history | `GET`  | `/SubstanceReferenceInformation/_history` |
...
- Search parameters: [`SubstanceReferenceInformation` search params](https://hl7.org/fhir/R5/substancereferenceinformation.html#search)
