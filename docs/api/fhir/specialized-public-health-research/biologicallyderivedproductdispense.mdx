...
description: Dispensing of a biologically derived product. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Dispensing of a biologically derived product.

## Endpoints

The standard FHIR R5 interactions for `BiologicallyDerivedProductDispense` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/BiologicallyDerivedProductDispense/[id]` |
| Vread      | `GET`    | `/BiologicallyDerivedProductDispense/[id]/_history/[vid]` |
| Update     | `PUT`    | `/BiologicallyDerivedProductDispense/[id]` |
| Patch      | `PATCH`  | `/BiologicallyDerivedProductDispense/[id]` |
| Delete     | `DELETE` | `/BiologicallyDerivedProductDispense/[id]` |
| Create     | `POST`   | `/BiologicallyDerivedProductDispense` |
| Search     | `GET`    | `/BiologicallyDerivedProductDispense?...` |
| History    | `GET`    | `/BiologicallyDerivedProductDispense/[id]/_history` |
| Type-history | `GET`  | `/BiologicallyDerivedProductDispense/_history` |
...
- Search parameters: [`BiologicallyDerivedProductDispense` search params](https://hl7.org/fhir/R5/biologicallyderivedproductdispense.html#search)
