...
description: Population, intervention or outcome being studied. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Population, intervention or outcome being studied.

## Endpoints

The standard FHIR R5 interactions for `EvidenceVariable` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/EvidenceVariable/[id]` |
| Vread        | `GET`    | `/EvidenceVariable/[id]/_history/[vid]` |
| Update       | `PUT`    | `/EvidenceVariable/[id]` |
| Patch        | `PATCH`  | `/EvidenceVariable/[id]` |
| Delete       | `DELETE` | `/EvidenceVariable/[id]` |
| Create       | `POST`   | `/EvidenceVariable` |
| Search       | `GET`    | `/EvidenceVariable?...` |
| History      | `GET`    | `/EvidenceVariable/[id]/_history` |
| Type-history | `GET`    | `/EvidenceVariable/_history` |
...
- Search parameters: [`EvidenceVariable` search params](https://hl7.org/fhir/R5/evidencevariable.html#search)
