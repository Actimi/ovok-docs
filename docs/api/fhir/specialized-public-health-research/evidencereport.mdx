...
description: Composition of evidence for review. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Composition of evidence for review.

## Endpoints

The standard FHIR R5 interactions for `EvidenceReport` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/EvidenceReport/[id]` |
| Vread      | `GET`    | `/EvidenceReport/[id]/_history/[vid]` |
| Update     | `PUT`    | `/EvidenceReport/[id]` |
| Patch      | `PATCH`  | `/EvidenceReport/[id]` |
| Delete     | `DELETE` | `/EvidenceReport/[id]` |
| Create     | `POST`   | `/EvidenceReport` |
| Search     | `GET`    | `/EvidenceReport?...` |
| History    | `GET`    | `/EvidenceReport/[id]/_history` |
| Type-history | `GET`  | `/EvidenceReport/_history` |
...
- Search parameters: [`EvidenceReport` search params](https://hl7.org/fhir/R5/evidencereport.html#search)
