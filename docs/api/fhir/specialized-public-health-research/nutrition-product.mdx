...
`NutritionProduct` supports the parameters below.
...
- Element bindings & profiles: [`NutritionProduct` profile](https://hl7.org/fhir/R5/nutritionproduct-definitions.html)
