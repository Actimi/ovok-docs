...
description: Definition of a clinical activity to be performed. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Definition of a clinical activity to be performed.

## Endpoints

The standard FHIR R5 interactions for `ActivityDefinition` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/ActivityDefinition/[id]` |
| Vread      | `GET`    | `/ActivityDefinition/[id]/_history/[vid]` |
| Update     | `PUT`    | `/ActivityDefinition/[id]` |
| Patch      | `PATCH`  | `/ActivityDefinition/[id]` |
| Delete     | `DELETE` | `/ActivityDefinition/[id]` |
| Create     | `POST`   | `/ActivityDefinition` |
| Search     | `GET`    | `/ActivityDefinition?...` |
| History    | `GET`    | `/ActivityDefinition/[id]/_history` |
| Type-history | `GET`  | `/ActivityDefinition/_history` |
...
- Search parameters: [`ActivityDefinition` search params](https://hl7.org/fhir/R5/activitydefinition.html#search)
