...
description: Container for knowledge / logic artifacts. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Container for knowledge / logic artifacts.

## Endpoints

The standard FHIR R5 interactions for `Library` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/Library/[id]` |
| Vread        | `GET`    | `/Library/[id]/_history/[vid]` |
| Update       | `PUT`    | `/Library/[id]` |
| Patch        | `PATCH`  | `/Library/[id]` |
| Delete       | `DELETE` | `/Library/[id]` |
| Create       | `POST`   | `/Library` |
| Search       | `GET`    | `/Library?...` |
| History      | `GET`    | `/Library/[id]/_history` |
| Type-history | `GET`    | `/Library/_history` |
...
- Search parameters: [`Library` search params](https://hl7.org/fhir/R5/library.html#search)
