...
description: Quality measure definition. FHIR R5 resource, served by the Ovok FHIR API.
---
...
The standard FHIR R5 interactions for `Measure` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/Measure/[id]` |
| Vread      | `GET`    | `/Measure/[id]/_history/[vid]` |
| Update     | `PUT`    | `/Measure/[id]` |
| Patch      | `PATCH`  | `/Measure/[id]` |
| Delete     | `DELETE` | `/Measure/[id]` |
| Create     | `POST`   | `/Measure` |
| Search     | `GET`    | `/Measure?...` |
| History    | `GET`    | `/Measure/[id]/_history` |
| Type-history | `GET`  | `/Measure/_history` |
...
- Search parameters: [`Measure` search params](https://hl7.org/fhir/R5/measure.html#search)
