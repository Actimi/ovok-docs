...
| `url` | `uri` | `1..1` | Canonical identifier for this measure, represented as a URI (globally unique) _must-support_ |
| `identifier` | `Identifier` | `0..*` | Additional identifier for the measure |
| `version` | `string` | `1..1` | Business version of the measure _must-support_ |
| `versionAlgorithm[x]` | `string` / `Coding` | `0..1` | How to compare versions _must-support_ |
| `name` | `string` | `0..1` | Name for this measure (computer friendly) _must-support_ |
| `title` | `string` | `1..1` | Name for this measure (human friendly) _must-support_ |
...
| `description` | `markdown` | `1..1` | Natural language description of the measure _must-support_ |
