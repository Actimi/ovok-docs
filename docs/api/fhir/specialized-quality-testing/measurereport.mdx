...
description: Results of running a Measure. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Results of running a Measure.

## Endpoints

The standard FHIR R5 interactions for `MeasureReport` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/MeasureReport/[id]` |
| Vread      | `GET`    | `/MeasureReport/[id]/_history/[vid]` |
| Update     | `PUT`    | `/MeasureReport/[id]` |
| Patch      | `PATCH`  | `/MeasureReport/[id]` |
| Delete     | `DELETE` | `/MeasureReport/[id]` |
| Create     | `POST`   | `/MeasureReport` |
| Search     | `GET`    | `/MeasureReport?...` |
| History    | `GET`    | `/MeasureReport/[id]/_history` |
| Type-history | `GET`  | `/MeasureReport/_history` |
...
- Search parameters: [`MeasureReport` search params](https://hl7.org/fhir/R5/measurereport.html#search)
