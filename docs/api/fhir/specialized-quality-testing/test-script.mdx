...
description: Suite of tests against a FHIR server. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Suite of tests against a FHIR server.

## Endpoints

The standard FHIR R5 interactions for `TestScript` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/TestScript/[id]` |
| Vread        | `GET`    | `/TestScript/[id]/_history/[vid]` |
| Update       | `PUT`    | `/TestScript/[id]` |
| Patch        | `PATCH`  | `/TestScript/[id]` |
| Delete       | `DELETE` | `/TestScript/[id]` |
| Create       | `POST`   | `/TestScript` |
| Search       | `GET`    | `/TestScript?...` |
| History      | `GET`    | `/TestScript/[id]/_history` |
| Type-history | `GET`    | `/TestScript/_history` |
...
- Search parameters: [`TestScript` search params](https://hl7.org/fhir/R5/testscript.html#search)
