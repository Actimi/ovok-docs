...
`TerminologyCapabilities` supports the parameters below.
...
- Element bindings & profiles: [`TerminologyCapabilities` profile](https://hl7.org/fhir/R5/terminologycapabilities-definitions.html)
