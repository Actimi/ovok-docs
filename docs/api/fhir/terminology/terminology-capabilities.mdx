...
description: Terminology capabilities of a server. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Terminology capabilities of a server.

## Endpoints

The standard FHIR R5 interactions for `TerminologyCapabilities` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/TerminologyCapabilities/[id]` |
| Vread        | `GET`    | `/TerminologyCapabilities/[id]/_history/[vid]` |
| Update       | `PUT`    | `/TerminologyCapabilities/[id]` |
| Patch        | `PATCH`  | `/TerminologyCapabilities/[id]` |
| Delete       | `DELETE` | `/TerminologyCapabilities/[id]` |
| Create       | `POST`   | `/TerminologyCapabilities` |
| Search       | `GET`    | `/TerminologyCapabilities?...` |
| History      | `GET`    | `/TerminologyCapabilities/[id]/_history` |
| Type-history | `GET`    | `/TerminologyCapabilities/_history` |
...
- Search parameters: [`TerminologyCapabilities` search params](https://hl7.org/fhir/R5/terminologycapabilities.html#search)
