...
| `extension:authoritativeSource` | `Extension` | `0..1` | Reference to the current trusted source of the ValueSet resource (metadata and definition) _must-support_ |
| `url` | `uri` | `1..1` | Canonical identifier for this value set, represented as a URI (globally unique) _must-support_ |
| `identifier` | `Identifier` | `0..*` | Additional identifier for the value set (business identifier) |
| `version` | `string` | `1..1` | Business version of the value set _must-support_ |
| `versionAlgorithm[x]` | `string` / `Coding` | `0..1` | How to compare versions _must-support_ |
| `name` | `string` | `0..1` | Name for this value set (computer friendly) _must-support_ |
| `title` | `string` | `1..1` | Name for this value set (human friendly) _must-support_ |
...
| `description` | `markdown` | `1..1` | Natural language description of the value set _must-support_ |
...
`ValueSet` supports the parameters below.
...
- Element bindings & profiles: [`ValueSet` profile](https://hl7.org/fhir/R5/valueset-definitions.html)
