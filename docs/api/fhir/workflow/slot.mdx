...
title: Slot
sidebar_label: Slot
description: Slot of time on a Schedule that may be available. FHIR R5 resource, served by the Ovok FHIR API.
---
...
Slot of time on a Schedule that may be available.

## Endpoints

The standard FHIR R5 interactions for `Slot` are mounted under your
...
| --- | --- | --- |
| Read         | `GET`    | `/Slot/[id]` |
| Vread        | `GET`    | `/Slot/[id]/_history/[vid]` |
| Update       | `PUT`    | `/Slot/[id]` |
| Patch        | `PATCH`  | `/Slot/[id]` |
| Delete       | `DELETE` | `/Slot/[id]` |
| Create       | `POST`   | `/Slot` |
| Search       | `GET`    | `/Slot?...` |
| History      | `GET`    | `/Slot/[id]/_history` |
| Type-history | `GET`    | `/Slot/_history` |
...
- Search parameters: [`Slot` search params](https://hl7.org/fhir/R5/slot.html#search)
