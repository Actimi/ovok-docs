...
title: Task
sidebar_label: Task
description: A unit of work to be performed. FHIR R5 resource, served by the Ovok FHIR API.
---
...
The standard FHIR R5 interactions for `Task` are mounted under your
...
| --- | --- | --- |
| Read       | `GET`    | `/Task/[id]` |
| Vread      | `GET`    | `/Task/[id]/_history/[vid]` |
| Update     | `PUT`    | `/Task/[id]` |
| Patch      | `PATCH`  | `/Task/[id]` |
| Delete     | `DELETE` | `/Task/[id]` |
| Create     | `POST`   | `/Task` |
| Search     | `GET`    | `/Task?...` |
| History    | `GET`    | `/Task/[id]/_history` |
| Type-history | `GET`  | `/Task/_history` |
...
- Search parameters: [`Task` search params](https://hl7.org/fhir/R5/task.html#search)
