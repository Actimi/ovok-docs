---
title: Bots - Execute a custom script
description: Bots - Execute a custom script endpoints in the Ovok platform API.
sidebar_label: Bots - Execute a custom script
---
...
### Execute a bot with request body {#botscontroller-execbotbyidentifierpost}
