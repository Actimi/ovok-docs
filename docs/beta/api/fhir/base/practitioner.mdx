...
| `active` | `boolean` | `0..1` | Whether this practitioner's record is in active use _modifier_ |
...
- Official FHIR R5 spec: [`Practitioner`](https://hl7.org/fhir/R5/practitioner.html)
