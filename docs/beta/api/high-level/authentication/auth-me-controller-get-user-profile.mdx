...
<div className="endpoint-hero__paths">
  <div className="endpoint-hero__path-row"><span className="api-method get">GET</span> <code className="endpoint-hero__path">{"/auth/me"}</code></div>
</div>
...
```bash
curl -X GET \
 --url 'https://api.staging.ovok.com/auth/me' \
