...
description: The Ovok platform API on the beta tier — auth, projects, content, billing, devices, signals.
---
...
- **[AI Translation](/beta/api/high-level/ai-translation/translation-controller-translate)** — 1 endpoint
- **[Authentication](/beta/api/high-level/authentication/auth-me-controller-get-user-profile)** — 5 endpoints
...
- **[Organization Code Information](/beta/api/high-level/organization-code-information/organization-code-controller-get-organization-code)** — 2 endpoints
- **[Partner](/beta/api/high-level/partner/partner-controller-health-check)** — 4 endpoints
- **[Tenant Authentication](/beta/api/high-level/tenant-authentication/tenant-patient-auth-controller-finish-login)** — 7 endpoints

## Stability

Not every endpoint is at the same release stage. The
[API stability](/beta/api/stability) page lists everything tagged
**Early Access** or **Deprecated** on this tier so you can scope
production integrations cleanly.

## Tier

You're viewing the **beta** tier. Switch tiers from the navbar to
see the equivalent docs for another release surface.

The machine-readable spec for this tier is at
[`/openapi/beta-public.yaml`](pathname:///openapi/beta-public.yaml).
