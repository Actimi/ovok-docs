...
Scroll to the section titled **Payload CMS**. You'll see:

> **Payload CMS**
>
> Opt this project into the new Payload-backed CMS. Flipping on triggers
> tenant provisioning + adds a CMS line item to your Stripe subscription.
>
