...
sidebar_label: ImagingSelection
description: "A selection of DICOM SOP instances and/or frames within a single Study and Series. This might include additional specifics such as an image region, an Observati"
---
...
<ApiBase surface="fhir" path="/ImagingSelection" inline={false} />
...
| `status` | `code` | `1..1` | available | entered-in-error | unknown _modifier_ |
...
- Official FHIR R5 spec: [`ImagingSelection`](https://hl7.org/fhir/R5/imagingselection.html)
