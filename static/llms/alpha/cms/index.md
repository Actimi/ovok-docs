...
- **Console** — `/settings/general` flips the project into the CMS.
  ...
  Stripe subscription. See [Enable CMS](/alpha/cms/enable).
...
[Payload stack](/alpha/platform/payload-stack) and
[CMS environments](/alpha/cms/environments).

## Next

- [Enable CMS on your project](/alpha/cms/enable) — three clicks in the Console
- [CMS environments](/alpha/cms/environments) — dev / staging / prod isolation
- [Authoring](/alpha/cms/authoring) — write content from your backend
- [Public delivery](/alpha/cms/public-delivery) — serve content to apps
- [API keys](/alpha/cms/api-keys) — mint, rotate, and scope delivery keys
