...
| Tier      | Host                       |
| --------- | -------------------------- |
| **alpha** | `console.sandbox.ovok.com`     |
| **beta**  | `console.staging.eu.ovok.com` |
...
See [Enable CMS](/alpha/cms/enable) for the full step-by-step on the
Payload CMS toggle.
...
See [CMS API keys](/alpha/cms/api-keys) for the full mint / rotate /
scope guide.
