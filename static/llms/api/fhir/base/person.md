...
`Person` supports the parameters below.
...
- Official FHIR R5 spec: [`Person`](https://hl7.org/fhir/R5/person.html)
- Element bindings & profiles: [`Person` profile](https://hl7.org/fhir/R5/person-definitions.html)
