...
<ApiBase surface="fhir" path="/SupplyRequest" inline={false} />
...
`SupplyRequest` supports the parameters below.
...
- Element bindings & profiles: [`SupplyRequest` profile](https://hl7.org/fhir/R5/supplyrequest-definitions.html)
