...
`QuestionnaireResponse` supports the parameters below.
...
- Element bindings & profiles: [`QuestionnaireResponse` profile](https://hl7.org/fhir/R5/questionnaireresponse-definitions.html)
