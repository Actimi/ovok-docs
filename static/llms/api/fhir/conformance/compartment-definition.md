...
`CompartmentDefinition` supports the parameters below.
...
- Element bindings & profiles: [`CompartmentDefinition` profile](https://hl7.org/fhir/R5/compartmentdefinition-definitions.html)
