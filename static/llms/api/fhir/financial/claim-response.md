...
| --- | --- | --- |
| Read         | `GET`    | `/fhir/R5/ClaimResponse/[id]` |
| Vread        | `GET`    | `/fhir/R5/ClaimResponse/[id]/_history/[vid]` |
| Update       | `PUT`    | `/fhir/R5/ClaimResponse/[id]` |
| Patch        | `PATCH`  | `/fhir/R5/ClaimResponse/[id]` |
| Delete       | `DELETE` | `/fhir/R5/ClaimResponse/[id]` |
| Create       | `POST`   | `/fhir/R5/ClaimResponse` |
| Search       | `GET`    | `/fhir/R5/ClaimResponse?...` |
| History      | `GET`    | `/fhir/R5/ClaimResponse/[id]/_history` |
| Type-history | `GET`    | `/fhir/R5/ClaimResponse/_history` |
...
`ClaimResponse` supports the parameters below.
...
- Element bindings & profiles: [`ClaimResponse` profile](https://hl7.org/fhir/R5/claimresponse-definitions.html)
