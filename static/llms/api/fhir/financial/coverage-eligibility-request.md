...
`CoverageEligibilityRequest` supports the parameters below.
...
- Element bindings & profiles: [`CoverageEligibilityRequest` profile](https://hl7.org/fhir/R5/coverageeligibilityrequest-definitions.html)
