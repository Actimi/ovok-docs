...
`CoverageEligibilityResponse` supports the parameters below.
...
- Element bindings & profiles: [`CoverageEligibilityResponse` profile](https://hl7.org/fhir/R5/coverageeligibilityresponse-definitions.html)
