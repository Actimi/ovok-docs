...
sidebar_label: PaymentReconciliation
...
<ApiBase surface="fhir" path="/PaymentReconciliation" inline={false} />
...
`PaymentReconciliation` supports the parameters below.
...
- Official FHIR R5 spec: [`PaymentReconciliation`](https://hl7.org/fhir/R5/paymentreconciliation.html)
- Element bindings & profiles: [`PaymentReconciliation` profile](https://hl7.org/fhir/R5/paymentreconciliation-definitions.html)
