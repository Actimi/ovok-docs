...
sidebar_label: DeviceDispense
description: "Indicates that a device is to be or has been dispensed for a named person/patient.  This includes a description of the product (supply) provided and the instruc"
---
...
<ApiBase surface="fhir" path="/DeviceDispense" inline={false} />
...
`DeviceDispense` supports the parameters below.
...
- Official FHIR R5 spec: [`DeviceDispense`](https://hl7.org/fhir/R5/devicedispense.html)
- Element bindings & profiles: [`DeviceDispense` profile](https://hl7.org/fhir/R5/devicedispense-definitions.html)
