...
`ClinicalUseDefinition` supports the parameters below.
...
- Element bindings & profiles: [`ClinicalUseDefinition` profile](https://hl7.org/fhir/R5/clinicalusedefinition-definitions.html)
