...
`ManufacturedItemDefinition` supports the parameters below.
...
- Element bindings & profiles: [`ManufacturedItemDefinition` profile](https://hl7.org/fhir/R5/manufactureditemdefinition-definitions.html)
