...
`ActivityDefinition` supports the parameters below.
...
- Element bindings & profiles: [`ActivityDefinition` profile](https://hl7.org/fhir/R5/activitydefinition-definitions.html)
