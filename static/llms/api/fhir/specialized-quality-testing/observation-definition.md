...
`ObservationDefinition` supports the parameters below.
...
- Element bindings & profiles: [`ObservationDefinition` profile](https://hl7.org/fhir/R5/observationdefinition-definitions.html)
