...
<div className="endpoint-hero__paths">
  ...
  <div className="endpoint-hero__path-row"><span className="api-method get">GET</span> <code className="endpoint-hero__path">{"/internal/cms/{type}/map/{language}"}</code></div>
</div>
