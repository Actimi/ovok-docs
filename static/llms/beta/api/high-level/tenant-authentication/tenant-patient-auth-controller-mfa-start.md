...
<div className="endpoint-hero__paths">
  <div className="endpoint-hero__path-row"><span className="api-method post">POST</span> <code className="endpoint-hero__path">{"/auth/tenant/Patient/login/mfa"}</code></div>
</div>
...
### `200` → `StartPatientMFAResponseDto` (`application/json`)
...
{
  "nextStep": "token",
  "sessionCode": "1lv5M102MC3bsO5wzQJKeagBfq9w4MVo"
}
```
